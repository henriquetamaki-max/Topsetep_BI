...
def _render_adherence_dashboard(by_day) -> None:
    """Dashboard de cumprimento do plano (M16): streak + score semanal/mensal +
    heatmap-calendário + violações por tipo. Renderizado acima da tabela diária."""
...
def render_risk_review(user: dict, plan: dict | None, groups, plans) -> None:
    ...
    # Dashboard de cumprimento vem ANTES da tabela de veredito por dia.
    _render_adherence_dashboard(by_day)
