...
//    A linha esperada é "custom indicator injetado v0.3.3".
//
// Novidades v0.3.0:
    ...
    const metainfo = {
      ...
      defaults: {
        styles: {
          ...
          // Sem texto (TT v31 da Topstep não honra `text` em shapes). Legenda:
          // losango = A+, triângulo = B, xcross = C; cor distingue o setup.
          long_a:   { color: COLORS.LONG_A,  textColor: COLORS.LONG_A,  transparency: 0, visible: true, size: 'huge',   location: 'BelowBar', plottype: 'shape_diamond'       },
          long_b:   { color: COLORS.LONG_B,  textColor: COLORS.LONG_B,  transparency: 0, visible: true, size: 'huge',   location: 'BelowBar', plottype: 'shape_triangle_up'   },
          long_c:   { color: COLORS.LONG_C,  textColor: COLORS.LONG_C,  transparency: 0, visible: true, size: 'huge',   location: 'BelowBar', plottype: 'shape_xcross'        },
          short_a:  { color: COLORS.SHORT_A, textColor: COLORS.SHORT_A, transparency: 0, visible: true, size: 'huge',   location: 'AboveBar', plottype: 'shape_diamond'       },
          short_b:  { color: COLORS.SHORT_B, textColor: COLORS.SHORT_B, transparency: 0, visible: true, size: 'huge',   location: 'AboveBar', plottype: 'shape_triangle_down'  },
          short_c:  { color: COLORS.SHORT_C, textColor: COLORS.SHORT_C, transparency: 0, visible: true, size: 'huge',   location: 'AboveBar', plottype: 'shape_xcross'        },
